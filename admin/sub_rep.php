...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <br />
            <div class="x_title">
                <h2><i class="fa fa-book"></i> Subject for Replacement Books List</h2>
            ...
            <div class="x_content">
                ...
                <div class="table-responsive">
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                        ...
                        <tbody>
                            <?php
                            $result = mysqli_query($con, "SELECT * FROM book WHERE status = 'Replacement' ORDER BY book_id DESC") or die(mysqli_error());
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    $available_copies = isset($row['available_copies']) ? $row['available_copies'] : $row['book_copies'];
                                    if ($available_copies == 0) {
                                        echo '<span class="label label-danger">' . $available_copies . '</span>';
                                    } elseif ($available_copies < $row['book_copies']) {
                                        echo '<span class="label label-warning">' . $available_copies . '</span>';
                                    } else {
                                        echo '<span class="label label-success">' . $available_copies . '</span>';
                                    }
                                    ?>
                                </td> 
                                ...
                                <td>
                                    ...
                                    if ($remarks == 'Available') {
                                        echo '<span class="label label-success">' . $remarks . '</span>';
                                    } else {
                                        echo '<span class="label label-danger">' . $remarks . '</span>';
                                    }
                                    ?>
                                </td> 
                                <td>
