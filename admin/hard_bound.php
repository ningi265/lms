...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <br />
            <div class="x_title">
                <h2><i class="fa fa-book"></i> Hardbound Books List</h2>
            ...
            <div class="x_content">
                ...
                <div class="table-responsive">
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                        ...
                        <tbody>
                            <?php
                            $result = mysqli_query($con, "SELECT * FROM book WHERE status = 'Hardbound' ORDER BY book_id DESC") or die(mysqli_error());
